import { Auth, Storage, type AuthState, type TransactionChunk, type PresenceOpts, type PresenceResponse, type RoomSchemaShape, type InstaQLQueryParams, type DoNotUseConfig, type PageInfoResponse, DoNotUseInstantClient, DoNotUseDoNotUseLifecycleSubscriptionState, DoNotUseQueryResponse, RoomsOf, DoNotUseInstantSchema, IDoNotUseDatabase } from "@instantdb/core";
...
export declare class DoNotUseInstantReactRoom<Schema extends DoNotUseInstantSchema<any, any, any>, RoomSchema extends RoomSchemaShape, RoomType extends keyof RoomSchema> {
    _core: DoNotUseInstantClient<Schema>;
    type: RoomType;
    id: string;
    constructor(_core: DoNotUseInstantClient<Schema>, type: RoomType, id: string);
    /**
...
export declare abstract class DoNotUseInstantReact<Schema extends DoNotUseInstantSchema<any, any, any>, Rooms extends RoomSchemaShape = RoomsOf<Schema>> implements IDoNotUseDatabase<Schema> {
     ...
     */
    room<RoomType extends keyof Rooms>(type?: RoomType, id?: string): DoNotUseInstantReactRoom<Schema, Rooms, RoomType>;
    /**
     ...
     */
    useQuery: <Q extends InstaQLQueryParams<Schema>>(query: null | Q) => DoNotUseDoNotUseLifecycleSubscriptionState<Q, Schema>;
    /**
...
//# sourceMappingURL=DoNotUseInstantReact.d.ts.map