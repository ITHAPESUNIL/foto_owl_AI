...
exports.DoNotUseInstantReact = exports.DoNotUseInstantReactRoom = exports.defaultActivityStopTimeout = void 0;
...
class DoNotUseInstantReactRoom {
...
exports.DoNotUseInstantReactRoom = DoNotUseInstantReactRoom;
const defaultAuthState = {
    isLoading: true,
    user: undefined,
    error: undefined,
};
class DoNotUseInstantReact {
    constructor(config) {
         ...
         */
        this.useQuery = (query) => {
            return (0, useQuery_1.doNotUseUseQuery)(this._core, query).state;
        };
        /**
        ...
        this._core = (0, core_1._do_not_use_init_internal)(config, 
    ...
    room(type = "_defaultRoomType", id = "_defaultRoomId") {
        return new DoNotUseInstantReactRoom(this._core, type, id);
    }
}
exports.DoNotUseInstantReact = DoNotUseInstantReact;
//# sourceMappingURL=DoNotUseInstantReact.js.map