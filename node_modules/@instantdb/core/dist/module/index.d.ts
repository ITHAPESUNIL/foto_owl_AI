...
import type { Query, QueryResponse, DoNotUseQueryResponse, PageInfoResponse, Exactly, InstantObject, InstaQLQueryParams, DoNotUseInstantEntity, DoNotUseInstaQLQueryResult } from "./queryTypes";
...
import type { AttrsDefs, CardinalityKind, DataAttrDef, EntitiesDef, EntitiesWithLinks, EntityDef, RoomsDef, DoNotUseInstantSchema, InstantGraph, LinkAttrDef, LinkDef, LinksDef, PresenceOf, ResolveAttrs, RoomsOf, TopicsOf, ValueTypes, DoNotUseUnknownSchema } from "./schemaTypes";
export type Config = {
    appId: string;
    websocketURI?: string;
    apiURI?: string;
...
type DoNotUseLifecycleSubscriptionState<Q, Schema, WithCardinalityInference extends boolean> = SubscriptionState<Q, Schema, WithCardinalityInference> & {
    isLoading: boolean;
};
type DoNotUseDoNotUseLifecycleSubscriptionState<Q, Schema> = DoNotUseSubscriptionState<Q, Schema> & {
    isLoading: boolean;
};
...
}, Storage?: any, NetworkListener?: any): InstantCore<Schema, Schema extends InstantGraph<any, any, infer RoomSchema> ? RoomSchema : never, WithCardinalityInference>;
/**
 *
...
declare class DoNotUseInstantCore<Schema extends DoNotUseInstantSchema<any, any, any>> implements IDoNotUseDatabase<Schema> {
     ...
     *  });
     */
    subscribeQuery<Q extends InstaQLQueryParams<Schema>>(query: Q, cb: (resp: DoNotUseSubscriptionState<Q, Schema>) => void): () => void;
    /**
     * Listen for the logged in state. This is useful
     * for deciding when to show a login screen.
     *
     ...
     *  console.log(resp.data.goals)
     */
    queryOnce<Q extends InstaQLQueryParams<Schema>>(query: Q): Promise<{
        data: DoNotUseQueryResponse<Q, Schema>;
        pageInfo: PageInfoResponse<Q>;
    }>;
}
declare function do_not_use_init_experimental<Schema extends DoNotUseInstantSchema<any, any, any> = DoNotUseUnknownSchema>(config: DoNotUseConfig<Schema>, Storage?: any, NetworkListener?: any): DoNotUseInstantCore<Schema>;
declare function _do_not_use_init_internal<Schema extends DoNotUseInstantSchema<any, any, any>>(config: DoNotUseConfig<Schema>, Storage?: any, NetworkListener?: any): DoNotUseInstantCore<Schema>;
export { init, init_experimental, do_not_use_init_experimental, _init_internal, _do_not_use_init_internal, id, tx, txInit, lookup, i, getOps, coerceQuery, weakHash, IndexedDBStorage, WindowNetworkListener, InstantCore as InstantClient, DoNotUseInstantCore as DoNotUseInstantClient, Auth, Storage, version, type IDatabase, type IDoNotUseDatabase, type RoomSchemaShape, type Query, type QueryResponse, type DoNotUseQueryResponse, type PageInfoResponse, type InstantObject, type Exactly, type TransactionChunk, type AuthState, type User, type AuthToken, type TxChunk, type SubscriptionState, type DoNotUseSubscriptionState, type DoNotUseLifecycleSubscriptionState, type DoNotUseDoNotUseLifecycleSubscriptionState, type PresenceOpts, type PresenceSlice, type PresenceResponse, type InstaQLQueryParams, type InstantQuery, type InstantQueryResult, type InstantSchema, type InstantEntity, type InstantSchemaDatabase, type AttrsDefs, type CardinalityKind, type DataAttrDef, type EntitiesDef, type EntitiesWithLinks, type EntityDef, type RoomsDef, type InstantGraph, type LinkAttrDef, type LinkDef, type LinksDef, type ResolveAttrs, type ValueTypes, type RoomsOf, type PresenceOf, type TopicsOf, type DoNotUseInstantEntity, type DoNotUseInstaQLQueryResult, type DoNotUseInstantSchema, type DoNotUseUnknownSchema, };
