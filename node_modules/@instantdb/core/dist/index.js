...
exports.version = exports.Storage = exports.Auth = exports.DoNotUseInstantClient = exports.InstantClient = exports.WindowNetworkListener = exports.IndexedDBStorage = exports.weakHash = exports.getOps = exports.i = exports.lookup = exports.txInit = exports.tx = exports.id = void 0;
exports.init = init;
...
exports._do_not_use_init_internal = _do_not_use_init_internal;
...
exports.DoNotUseInstantClient = DoNotUseInstantCore;
function do_not_use_init_experimental(config, Storage, NetworkListener) {
    return _do_not_use_init_internal(config, Storage, NetworkListener);
}
function _do_not_use_init_internal(config, Storage, NetworkListener) {
    const existingClient = globalInstantCoreStore[config.appId];
    if (existingClient) {
        return existingClient;
    }
